                ...
                <div class="card-header border-0">
                    ...
                    <div class="card-toolbar">
                        <div id="invBulkBar" class="d-none d-flex align-items-center gap-2">
                            ...
                            <button class="btn btn-sm btn-light-info inv-bulk-btn" data-action="merge">
        ...
        $(document).ready(function () {
            ...
            $(document).on('click', '.inv-bulk-btn', function() {
                ...
                var msgs = {
                    ...
                    'merge': ids.length + ' faturayı tek fatura altında birleştirmek istediğinize emin misiniz?'
                };
                ...
                Swal.fire({
                    title: 'Toplu İşlem',
                    text: msgs[action] || 'Emin misiniz?',
                    icon: (action === 'delete' || action === 'merge') ? 'warning' : 'question',
                    showCancelButton: true,
                    confirmButtonText: 'Evet, uygula',
                    cancelButtonText: 'Vazgeç',
                    confirmButtonColor: action === 'delete' ? '#dc3545' : '#3085d6',
