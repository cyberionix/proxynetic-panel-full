<div style="text-align: center">
    <div>
        <span style="color:#2943c4;">{{$support->user->id}} | {{$support->user->full_name}}</span> adlı müşteri #{{$support->id}} numaralı destek talebini yanıtladı.<br>
