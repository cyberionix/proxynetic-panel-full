...
return new class extends Migration
{
    ...
    public function down(): void
    {
        $driver = DB::getDriverName();
        if ($driver === 'mysql') {
            DB::statement("ALTER TABLE invoice_items MODIFY COLUMN type ENUM('NEW','RENEW','UPGRADE','BALANCE','ADDITIONAL_QUOTA','ADDITIONAL_QUOTA_DURATION') DEFAULT 'NEW'");
        }
    }
};
